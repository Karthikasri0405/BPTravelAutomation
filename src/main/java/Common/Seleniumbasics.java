...
public class Seleniumbasics {
	...
	public WebDriver browserStart(String URL) 
	{
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Karthika\\Downloads\\chromedriver_win32\\chromedriver.exe");
	...
	public void selectByVisibleText(WebElement ele, String toelemt)
	{
		Select st = new Select(ele);
		st.selectByVisibleText(toelemt);
	}
